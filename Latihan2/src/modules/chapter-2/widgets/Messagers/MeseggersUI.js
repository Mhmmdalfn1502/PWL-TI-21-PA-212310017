...
const MeseggersUI = ({ profile, selectedChat, selectedUser, selectedChatId }) => {
  const chatArr = [
    ...
    <div className="card">
      ...
      <div className="card-body p-0">
        ...
        <div className="chat-message bg-light-primary" style={StylesMessager.chatBox}>
          <ChatBody data={myChat} releaseDate={releaseDate} selectedChatId={selectedChatId} /> {/* Mengirimkan props selectedChatId ke komponen ChatBody */}
